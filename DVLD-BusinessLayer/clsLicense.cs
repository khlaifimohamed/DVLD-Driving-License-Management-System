...
namespace DVLD_BusinessLayer
{
    public  class   clsLicense
    {
        ...
        public bool ReleaseDetainedLicense(int ReleaesedByUserID,ref int ApplicationID)
        {
            ...
            application.CreatedByUserID = ReleaesedByUserID;
            if (!application.Save())
            {
                return false;
            }
            ApplicationID = application.ApplicationID;
            return this.DetainedInfo.ReleaseDetainedLicense(ReleaesedByUserID, application.ApplicationID);
        ...
        public clsLicense Replace(enIssueReason IssueReason, int CreatedByUserID)
        {
            ...
            Application.ApplicantPersonID = this.DriverInfo.PersonID;
            Application.ApplicationDate = DateTime.Now;
            if(IssueReason == enIssueReason.DamagedReplacement)
            {
